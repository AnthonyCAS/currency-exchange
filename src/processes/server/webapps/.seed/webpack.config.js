...
var webpackConfig = {
  ...
  output: {
    publicPath: '',
    path: path.resolve(__dirname, manifest.distributionPath),
  },
  ...
  plugins: [
    ...
    new WebpackOnBuildPlugin(function(stats) {
      ...
      fs.copySync('src/assets', `${manifest.distributionPath}/assets`);
      fs.copySync('src/shared-assets', `${manifest.distributionPath}/shared-assets`);
      fs.copySync('src/favicon.ico', `${manifest.distributionPath}/favicon.ico`);
    }),
